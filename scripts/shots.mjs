...
const targets = [
  ...
  { name: 'home-tablet', url: '/', width: 768, height: 900 },
  { name: 'home-xga', url: '/', width: 1024, height: 900 },
  ...
  { name: 'observe-tablet', url: '/to-observe-and-report/', width: 768, height: 900 },
  { name: 'observe-xga', url: '/to-observe-and-report/', width: 1024, height: 900 },
  ...
  { name: 'article-tablet', url: '/to-observe-and-report/the-wall/', width: 768, height: 900 },
  { name: 'article-xga', url: '/to-observe-and-report/the-wall/', width: 1024, height: 900 },
  { name: 'cms-article-desktop', url: '/to-observe-and-report/hello-from-the-api/', width: 1380, height: 900 },
  { name: 'cms-article-mobile', url: '/to-observe-and-report/hello-from-the-api/', width: 390, height: 844 },
  { name: 'cms-article-tablet', url: '/to-observe-and-report/hello-from-the-api/', width: 768, height: 900 },
  { name: 'cms-article-xga', url: '/to-observe-and-report/hello-from-the-api/', width: 1024, height: 900 },
  ...
  { name: 'show-tablet', url: '/to-show-and-tell/windows-to-the-world/', width: 768, height: 900 },
